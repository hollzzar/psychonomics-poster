...
<img style="padding: 0 15px; float:left;" src="/images/Logo_CLA_blue.png" width=30% height=30%> <div style="text-align: right"><font size=6>Holly Zaharchuk: hzaharchuk@psu.edu</font></div> <div style="text-align: right"><font size=6>University Graduate Fellow (UGF)</font></div>